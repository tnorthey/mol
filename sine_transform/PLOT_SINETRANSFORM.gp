...
set output "PLOT_SINETRANSFORM.png"
...
DT2 = 2
DT3 = 3
plot "radial_function_qmax04.dat" u 1:2 t "q = [0, 4] Å^{-1}" w l ls 7 lw LW dt DT1, \
     "radial_function_qmax08.dat" u 1:2 t "    [0, 8] Å^{-1}" w l ls 1 lw LW dt DT1, \
     "radial_function_qmax24.dat" u 1:2 t "    [0, 24] Å^{-1}" w l ls 2 lw LW dt 5, \
