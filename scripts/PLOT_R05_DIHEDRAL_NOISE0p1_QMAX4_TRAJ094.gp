...
# STATS
stats "analysis_10_noise0p1_qmax4_traj094.dat" u 3 prefix "t10"
stats "analysis_20_noise0p1_qmax4_traj094.dat" u 3 prefix "t20"
stats "analysis_35_noise0p1_qmax4_traj094.dat" u 3 prefix "t35"
stats "analysis_40_noise0p1_qmax4_traj094.dat" u 3 prefix "t40"
stats "analysis_50_noise0p1_qmax4_traj094.dat" u 3 prefix "t50"
stats "analysis_60_noise0p1_qmax4_traj094.dat" u 3 prefix "t60"
stats "analysis_70_noise0p1_qmax4_traj094.dat" u 3 prefix "t70"
stats "analysis_75_noise0p1_qmax4_traj094.dat" u 3 prefix "t75"
...
set output "PLOT_R05_DIHEDRAL_NOISE0p1_QMAX4_TRAJ094.png"
...
plot "analysis_10_noise0p1_qmax4_traj094.dat" u 1:($3 < t10_range ? $2 : 1/0) t "10" w p pt 3 ps 2 lw 1 lc 6,\
     "analysis_20_noise0p1_qmax4_traj094.dat" u 1:($3 < t20_range ? $2 : 1/0) t "20" w p pt 6 ps 2 lw 1 lc 5,\
     "analysis_35_noise0p1_qmax4_traj094.dat" u 1:($3 < t35_range ? $2 : 1/0) t "35" w p pt 2 ps 1 lw 1 lc 2,\
     "analysis_40_noise0p1_qmax4_traj094.dat" u 1:($3 < t40_range ? $2 : 1/0) t "40" w p pt 6 ps 2 lw 1 lc 4,\
     "analysis_50_noise0p1_qmax4_traj094.dat" u 1:($3 < t50_range ? $2 : 1/0) t "50" w p pt 1 ps 2 lw 1 lc 6,\
     "analysis_60_noise0p1_qmax4_traj094.dat" u 1:($3 < t60_range ? $2 : 1/0) t "60" w p pt 6 ps 2 lw 4 lc 6,\
     "analysis_70_noise0p1_qmax4_traj094.dat" u 1:($3 < t70_range ? $2 : 1/0) t "70" w p pt 6 ps 2 lw 4 lc 0,\
     "analysis_75_noise0p1_qmax4_traj094.dat" u 1:($3 < t75_range ? $2 : 1/0) t "75" w p pt 5 ps 1 lw 1 lc 3,\
...
#plot "analysis_10_noise0p1_qmax4.dat" u 1:($3 < -231.73190 ? $2 : 1/0) t "10" w p pt 3 ps 2 lw 4 lc 6,\
     #"analysis_20_noise0p1_qmax4.dat" u 1:($3 < -231.64213 ? $2 : 1/0) t "20" w p pt 6 ps 2 lw 4 lc 1,\
     #"analysis_35_noise0p1_qmax4.dat" u 1:($3 < -231.58000 ? $2 : 1/0) t "30" w p pt 6 ps 2 lw 4 lc 2,\
     #"analysis_35_noise0p1_qmax4.dat" u 1:($3 < -231.59450 ? $2 : 1/0) t "35" w p pt 6 ps 2 lw 4 lc 3,\
     #"analysis_40_noise0p1_qmax4.dat" u 1:($3 < -231.57030 ? $2 : 1/0) t "40" w p pt 6 ps 2 lw 4 lc 4,\
     #"analysis_50_noise0p1_qmax4.dat" u 1:($3 < -231.54275 ? $2 : 1/0) t "50" w p pt 6 ps 2 lw 4 lc 0,\
     #"analysis_60_noise0p1_qmax4.dat" u 1:($3 < -231.49180 ? $2 : 1/0) t "60" w p pt 6 ps 2 lw 4 lc 6,\
