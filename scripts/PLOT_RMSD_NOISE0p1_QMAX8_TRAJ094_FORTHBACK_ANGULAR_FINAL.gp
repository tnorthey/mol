...
set output "PLOT_RMSD_NOISE0p1_QMAX8_TRAJ094_FORTHBACK_ANGULAR_FINAL.png"
...
plot "analysis_20_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t20_range & $4 < f20_range ? $5 : 1/0) t "20" w p pt 6 ps 2 lw 3 lc 8,\
     "analysis_35_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t35_range & $4 < f35_range ? $5 : 1/0) t "35" w p pt 4 ps 2 lw 3 lc 2,\
     "analysis_40_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t40_range & $4 < f40_range ? $5 : 1/0) t "40" w p pt 1 ps 2 lw 3 lc 1,\
     "analysis_44_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t44_range & $4 < f44_range ? $5 : 1/0) t "44" w p pt 7 ps 2 lw 3 lc 3,\
     "analysis_50_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t50_range & $4 < f50_range ? $5 : 1/0) t "50" w p pt 5 ps 2 lw 3 lc 4,\
     "analysis_55_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t55_range & $4 < f55_range ? $5 : 1/0) t "55" w p pt 1 ps 2 lw 3 lc 6,\
     "analysis_60_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t60_range & $4 < f60_range ? $5 : 1/0) t "60" w p pt 3 ps 2 lw 4 lc 7,\
     "analysis_65_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t65_range & $4 < f65_range ? $5 : 1/0) t "65" w p pt 2 ps 2 lw 4 lc 6,\
     "analysis_70_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t70_range & $4 < f70_range ? $5 : 1/0) t "70" w p pt 6 ps 2 lw 4 lc 0,\
     "analysis_75_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t75_range & $4 < f75_range ? $5 : 1/0) t "75" w p pt 5 ps 1 lw 1 lc 3,\
     "target_r05_dihedral_traj094_points.dat" u 1:($1*0.0) t "" w p pt 1 ps 90 lw 3 lc 7,\
     #"analysis_70_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t70_range ? $5 : 1/0) t "70" w p pt 6 ps 2 lw 4 lc 0,\
     #"analysis_75_noise0p1_qmax8_traj094_forthback_angular_final.dat" u 1:($3 < t75_range ? $5 : 1/0) t "75" w p pt 5 ps 1 lw 1 lc 3,\
