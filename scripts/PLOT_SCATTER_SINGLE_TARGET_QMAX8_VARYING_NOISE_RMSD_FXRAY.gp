...
set output "PLOT_SCATTER_SINGLE_TARGET_QMAX8_VARYING_NOISE_RMSD_FXRAY.png"
...
@XTICS; @YTICS
@KEY
set label 1 'q_{max} = 8 Å^{-1}' @POS
#set logscale x 10
set logscale y 10
p "analysis_20_results_noise0.0_qmax8_nrestarts2_traj094_strong_constraints_chd_single_target_20.dat" u 5:4 t "noise = 0.0" w p ls 6, \
  "analysis_20_results_noise0.1_qmax8_nrestarts2_traj094_strong_constraints_chd_single_target_20.dat" u 5:4 t "= 0.1" w p ls 7, \
  "analysis_20_results_noise1.0_qmax8_nrestarts2_traj094_strong_constraints_chd_single_target_20.dat" u 5:4 t "= 1.0" w p ls 1, \
  "analysis_20_results_noise2.0_qmax8_nrestarts2_traj094_strong_constraints_chd_single_target_20.dat" u 5:4 t "= 2.0" w p ls 2, \
  "analysis_20_results_noise4.0_qmax8_nrestarts2_traj094_strong_constraints_chd_single_target_20.dat" u 5:4 t "= 4.0" w p ls 3, \
  "analysis_20_results_noise8.0_qmax8_nrestarts2_traj094_strong_constraints_chd_single_target_20.dat" u 5:4 t "= 8.0" w p ls 4, \
  "analysis_20_results_noise16.0_qmax8_nrestarts2_traj094_strong_constraints_chd_single_target_20.dat" u 5:4 t "= 16.0" w p ls 5, \
