...
p    "<paste rmsd_lowest_quartile_qmax4_traj090_strong_constraints_a.dat rmsd_lowest_quartile_qmax4_traj099_strong_constraints_a.dat rmsd_lowest_quartile_qmax4_traj094_strong_constraints_a.dat"                 u (($2+$6+$10)/3) t "q_{max} = 4 Å^{-1}"     w lp lc rgb c1 lw LW1 dt DT1 pt PT1 ps PS1, \
     "<paste rmsd_lowest_quartile_qmax8_traj090_strong_constraints_a.dat rmsd_lowest_quartile_qmax8_traj099_strong_constraints_a.dat rmsd_lowest_quartile_qmax8_traj094_strong_constraints_a.dat"                 u (($2+$6+$10)/3) t " = 8 Å^{-1}"     w lp lc rgb c2 lw LW1 dt DT1 pt PT2 ps PS1, \
     "<paste rmsd_lowest_quartile_qmax4_traj090_weak_constraints_a.dat rmsd_lowest_quartile_qmax4_traj099_weak_constraints_a.dat rmsd_lowest_quartile_qmax4_traj094_weak_constraints_a.dat"                 u (($2+$5+$8)/3) t ""     w lp lc rgb c1 lw LW2 dt DT2 pt PT1 ps PS2, \
     "<paste rmsd_lowest_quartile_qmax8_traj090_weak_constraints_a.dat rmsd_lowest_quartile_qmax8_traj099_weak_constraints_a.dat rmsd_lowest_quartile_qmax8_traj094_weak_constraints_a.dat"                 u (($2+$5+$8)/3) t ""     w lp lc rgb c2 lw LW2 dt DT2 pt PT2 ps PS2, \
