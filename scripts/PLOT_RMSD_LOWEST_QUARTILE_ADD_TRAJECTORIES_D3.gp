...
set output "PLOT_RMSD_LOWEST_QUARTILE_ADD_TRAJECTORIES_D3.png"
...
p    "<paste rmsd_lowest_quartile_qmax4_traj090_d23.dat rmsd_lowest_quartile_qmax4_traj099_d23.dat rmsd_lowest_quartile_qmax4_traj094_d23.dat"                 u (($2+$5+$8)/3) t "q_{max} = 4 Å^{-1}"     w lp lc rgb c1 lw LW1 dt DT1 pt PT1 ps PS1, \
     "<paste rmsd_lowest_quartile_qmax8_traj090_d23.dat rmsd_lowest_quartile_qmax8_traj099_d23.dat rmsd_lowest_quartile_qmax8_traj094_d23.dat"                 u (($2+$5+$8)/3) t " = 8 Å^{-1}"     w lp lc rgb c2 lw LW1 dt DT1 pt PT2 ps PS1, \
     "<paste rmsd_lowest_quartile_qmax4_traj090_low_constraints_c3.dat rmsd_lowest_quartile_qmax4_traj099_low_constraints_c3.dat rmsd_lowest_quartile_qmax4_traj094_low_constraints_c3.dat"                 u (($2+$5+$8)/3) t ""     w lp lc rgb c1 lw LW2 dt DT2 pt PT1 ps PS2, \
     "<paste rmsd_lowest_quartile_qmax8_traj090_low_constraints_c3.dat rmsd_lowest_quartile_qmax8_traj099_low_constraints_c3.dat rmsd_lowest_quartile_qmax8_traj094_low_constraints_c3.dat"                 u (($2+$5+$8)/3) t ""     w lp lc rgb c2 lw LW2 dt DT2 pt PT2 ps PS2, \
