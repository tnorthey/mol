...
YTICS = " set ytics add ('' 10, '' 1, '' 0.1, '10^{-2}' 0.01, '10^{-3}' 0.001, '10^{-4}' 0.0001, '10^{-5}' 0.00001, '10^{-6}' 0.000001); \
           set mytics 10 ; \
           set ylabel 'd_{signal}' offset 5.5,-3"
...
set output "PLOT_SCATTER_RESULTS_TEST.png"
...
#set logscale x 10
set logscale y 10
p "analysis_10_results_test.dat" u 5:4 t "qmax = 4" w p ls 1, \
  "analysis_10_results_test_qmax8.dat" u 5:4 t "qmax = 8" w p ls 2
